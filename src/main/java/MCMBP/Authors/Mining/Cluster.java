...
public class Cluster {
	...
	public  void CreateJobs(String FilterBy , String Pipelines,String CrossrefEmail, String ElsevierToken , String PDBList , String JobParameters , String  ApplicationIdBack4app ,  String APIKeyBack4app) throws IOException, ParseException, URISyntaxException, InterruptedException {
		...
		for(String pdb : PMCMultiThreaded.PMCAndPDB.keySet()) {
			...
			Script+="\n java -Xmx3048m -jar "+JarPath+" MiningAuthors FilterBy=\"[structureId:"+pdb+"]\" Pipeline=\""+Pipelines+"\" CrossrefEmail="+CrossrefEmail+" ElsevierToken="+ElsevierToken+" ExtractingInformation=F "+" ApplicationIdBack4app="+ApplicationIdBack4app+" APIKeyBack4app="+APIKeyBack4app;
